...
Ahora hacemos fuerza bruta con `hydra` para ver si encontramos alguna contraseña válida para alguno de los usuarios válidos
...
Con el password del usuario root nos conectamos a la máquina víctima con mediante ssh
