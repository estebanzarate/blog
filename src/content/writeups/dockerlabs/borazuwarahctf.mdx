...
description: Combina enumeración web, análisis de metadatos, esteganografía, fuerza bruta sobre SSH y una configuración insegura de sudo.
lang: es
draft: false
...
difficulty: muyfacil
os: linux
hints: ["Steganography", "Brute force", "Sudoers"]
tags: ["web", "steganography", "brute-force", "ssh", "sudoers"]
---
