...
La web muestra dos links, uno a `home` y otro a `about`, ambos 
...
![Natas Level 7 Level 8 Cyberchef](@images/blog/overthewire-natas/natas-level7-level8-cyberchef.png)
